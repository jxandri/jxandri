...
const STRINGS = {
  en: {
    ...
    'map.gridside': 'squares of {n} explorer height{m}',
    'map.gridgeo': 'geodesic squares of {n} explorer heights of arc length',
  ...
  es: {
    ...
    'map.gridnote': 'Cada cuadrado mide lo que mide de alto el explorador —el doble, en longitud de arco, sobre una superficie que no es una gr\u00e1fica—, de modo que la malla es una regla y no un adorno. En una gr\u00e1fica es la ret\u00edcula del plano (x, y) levantada sobre la superficie; en una param\u00e9trica, sus l\u00edneas de par\u00e1metro; en una impl\u00edcita, donde la superficie corta los planos coordenados. Se dibuja por ambos lados, de modo que sigue siendo legible desde dentro.',
    ...
    'map.gridside': 'cuadrados de {n} altura de explorador{m}',
    'map.gridgeo': 'cuadrados geod\u00e9sicos de {n} alturas de explorador de arco',
