...
Este applet los pone uno al lado del otro y a la misma escala. El panel
izquierdo es el problema; el derecho es su respuesta. El costo marginal se dibuja en
...
\figher[1.0]{panels}{Los dos paneles con los ajustes de partida. Izquierda: el
problema, con el costo marginal, el medio y el variable medio. Derecha: la
curva de oferta de la empresa en el plano $(q, p)$. Los dos ejes son los mismos en
...
\item[El panel de la empresa] (izquierda). O bien las curvas marginales, o bien
  las totales, según el conmutador \ui{Panel de la empresa}.
\item[El panel de oferta] (derecha). La curva de oferta inversa en el plano
...
panel izquierdo como el área entre $p$ y el costo marginal, y en el derecho
...
$p = 1{,}6$. A la izquierda el excedente medido como integral de $p - CMg$
respecto de la cantidad; a la derecha, el mismo número medido como integral de
$q$ respecto del precio.}
...
\amexp La curva roja del panel izquierdo y la cian del derecho ocupan el mismo
...
\par\smallskip
Pregunte a la clase por qué el panel derecho no tiene curva de costo medio
...
\par\smallskip
Compruébelo con los números del panel izquierdo: $q^\ast = 2{,}869$,
