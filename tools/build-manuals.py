  ...
  sections=[
    ...
    sec("Qué hay en pantalla", "What is on screen", [
      ...
      table(*HEAD_LAYER, [
        ...
        ("Flechas de los efectos",
         ...
         "descomposición aparecen dos: uno <b>rojo</b> de B₀ a B<sub>S</sub> rotulado «E. Sustitución» y uno "
         "<b>azul</b> de B<sub>S</sub> a B₁ rotulado «E. Ingreso». Los mismos colores marcan los tramos sobre "
         "el eje x y sobre el eje y.",
         "The vectors. Without the decomposition you get only the total effect, B₀ to B₁. With it, "
         "two more appear: a <b>red</b> one from B₀ to B<sub>S</sub> labelled “Subst. effect” and a "
         "<b>blue</b> one from B<sub>S</sub> to B₁ labelled “Income effect”. The same colours mark the "
    ...
    sec("El caso de libro, en números", "The textbook case, in numbers", [
      ...
      steps([
        ...
        ("Enciende <b>Flechas de los efectos</b> y mira los ejes: los tramos rojo y azul del eje x "
         ...
         "Switch on <b>Effect arrows</b> and look at the axes: the red and blue stretches on the x "
...
var l0 = "es", t0 = "dark";
try{ l0 = localStorage.getItem("manual.lang") || "es";
     t0 = localStorage.getItem("manual.theme") || "dark"; }catch(e){}
